...
public class CommonReferenceDetailsImpl implements CommonReferenceDetailsService {
	...
	public void updateIsDeleted(CommonReferenceDetailsBean commonReferenceDetailsBean ) {
		...
		convertBeanToEntity = commonReferenceDetailsRepo.findById(commonReferenceDetailsBean.getReferenceDetailId()).get();
		...
		CommonReferenceTypeEntity byTypeName = commonReferenceTypeRepo.findByReferenceTypeName(commonReferenceDetailsBean.getReferenceDetailValue());
